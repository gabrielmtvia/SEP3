...
public class BookService : IBookService
{
   private static List<Book> _books = new List<Book>()
    ...
    public async Task<ServiceResponse<List<Book>>> GetBooksByGenreAsync(string genreUrl)
    {
        var books = _books.Where(b => b.Genres.Any(genre => genre.Type.ToLower() == genreUrl.ToLower())).ToList();
        var response = new ServiceResponse<List<Book>>();
